...
def get_default_optimization_params():
    return make_group(
        ...
        normal_weight_init=0.0,
        normal_weight_final=0.0,
        normal_start_iter=0,
        normal_alpha_min=0.001,
        normal_min_pixels=2048,
        normal_sign=-1.0,
        normal_confidence_mode="none",
        normal_confidence_depth_angle_deg=45.0,
        normal_confidence_edge_quantile=0.9,
        normal_confidence_edge_dilate_px=3,
        normal_confidence_edge_sources="rgb,normal,depth",
        normal_confidence_edge_floor=0.0,
        normal_confidence_depth_floor=0.0,
        normal_confidence_min=0.0,
        pseudo_view_weight_init=0.0,
        pseudo_view_weight_final=0.0,
        pseudo_view_start_iter=5000,
        pseudo_view_end_iter=0,
        pseudo_view_interval=1,
        pseudo_view_shift_ratio=0.03,
        pseudo_view_random_sign=True,
        pseudo_view_mask_mode="valid",
        pseudo_view_depth_rel_thresh=0.05,
        pseudo_view_min_pixels=2048,
        pseudo_view_detach_ref_depth=True,
        pseudo_normal_weight_init=0.0,
        pseudo_normal_weight_final=0.0,
        pseudo_normal_start_iter=5000,
        pseudo_normal_end_iter=0,
        pseudo_normal_interval=2,
        pseudo_normal_shift_ratio=0.03,
        pseudo_normal_random_sign=True,
        pseudo_normal_ref_depth_source="mono",
        pseudo_normal_alpha_min=0.01,
        pseudo_normal_min_pixels=2048,
